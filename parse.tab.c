...
yyreduce:
  ...
  case 2:
#line 39 "parse.y"
                           {(yyval.m_node) = newStmtNode(ProgramK); (yyval.m_node)->listChild[0] = (yyvsp[0].m_node);programNode = (yyval.m_node); programNode->name = "helloworld";}
...
#line 1441 "parse.tab.c"
  ...
  case 7:
#line 50 "parse.y"
                        {(yyval.m_node) = newExpNode(IdK); (yyval.m_node)->name = (yyvsp[0].m_id);}
#line 1447 "parse.tab.c"
    break;

  case 8:
#line 51 "parse.y"
                                                       {node *t = newExpNode(ConstK); t->val = (yyvsp[-1].m_num); (yyval.m_node) = newExpNode(ArrayK);(yyval.m_node)->nodeChild[0] = t;}
...
#line 54 "parse.y"
                                                                      ...
                                                                      (yyval.m_node)->name = (yyvsp[-4].m_id); (yyval.m_node)->listChild[0] = (yyvsp[-2].m_node);
...
#line 1499 "parse.tab.c"
  ...
  case 16:
#line 72 "parse.y"
                                                    {(yyval.m_node) = newExpNode(ArrayptrK); (yyval.m_node)->name = (yyvsp[-2].m_id);}
...
#line 1525 "parse.tab.c"
  ...
  case 20:
#line 82 "parse.y"
                                                                  {addNode((yyvsp[-2].m_node), (yyvsp[-1].m_node)); (yyval.m_node) = (yyvsp[-2].m_node);}
#line 1531 "parse.tab.c"
    break;

  case 21:
#line 83 "parse.y"
                              {(yyval.m_node) = newStmtNode(LocdeclK); addNode((yyval.m_node), (yyvsp[-1].m_node));}
...
#line 1627 "parse.tab.c"
  ...
  case 37:
#line 113 "parse.y"
                                       {(yyval.m_node)=newExpNode(AssignK); (yyval.m_node)->nodeChild[0] = (yyvsp[-2].m_node); (yyval.m_node)->nodeChild[1] = (yyvsp[0].m_node);}
...
#line 1651 "parse.tab.c"
  ...
  case 41:
#line 122 "parse.y"
                                                                      {(yyval.m_node) = newExpNode(OpK); (yyval.m_node)->nodeChild[0] = (yyvsp[-2].m_node); (yyval.m_node)->nodeChild[1] = (yyvsp[0].m_node); (yyval.m_node)->op = (yyvsp[-1].m_op);}
...
#line 1693 "parse.tab.c"
  ...
  case 48:
#line 132 "parse.y"
                                                     { (yyval.m_node) = newExpNode(AddK); (yyval.m_node)->op = (yyvsp[-1].m_op); (yyval.m_node)->nodeChild[0] = (yyvsp[-2].m_node); (yyval.m_node)->nodeChild[1] = (yyvsp[0].m_node);}
...
#line 1711 "parse.tab.c"
  ...
  case 51:
#line 137 "parse.y"
                         {(yyval.m_node) = newExpNode(MulK); (yyval.m_node)->op = (yyvsp[-1].m_op); (yyval.m_node)->nodeChild[0] = (yyvsp[-2].m_node); (yyval.m_node)->nodeChild[1] = (yyvsp[0].m_node);}
...
#line 1747 "parse.tab.c"
  ...
  case 57:
#line 145 "parse.y"
            {(yyval.m_node) = newExpNode(ConstK); (yyval.m_node)->val = (yyvsp[0].m_num);}
#line 1753 "parse.tab.c"
    break;

  case 58:
#line 148 "parse.y"
                                        {(yyval.m_node) = newExpNode(CallK); (yyval.m_node)->listChild[0] = (yyvsp[-1].m_node); (yyval.m_node)->name = (yyvsp[-3].m_id);}
#line 1759 "parse.tab.c"
    break;

  case 59:
#line 149 "parse.y"
                                    {(yyval.m_node) = newExpNode(CallK); (yyval.m_node)->name = (yyvsp[-2].m_id);}
